...
//add a static method to return List of some products'
	static List<Product> populateProductList() {
		...
		list.add(new Product(60, "Sunflower_Oil", "Healthy Oil", 50, 240, OIL, parse("2022-01-20")));
		list.add(new Product(70, "Gemini_Oil", "Vegetable Oil", 80, 220, OIL, parse("2022-01-30")));
		list.add(new Product(62, "Dhara_Oil", "Healthier Oil", 55, 270, OIL, parse("2022-09-20")));
		list.add(new Product(75, "Gemini2_Oil", "Vegetable Oil", 84, 200, OIL, parse("2023-01-30")));
